...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/data/Pirate.oep");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/data/testland.oel");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/images/cowboy.png");
		...
		urls.push ("assets/images/walls.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/wallssmall.png");
		types.push (lime.Assets.AssetType.IMAGE);
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 1024, 576, "000000");
		#end
		#else
		create ();
		#end
